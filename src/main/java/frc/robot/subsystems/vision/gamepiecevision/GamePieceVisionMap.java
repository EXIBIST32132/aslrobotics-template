...
public final class GamePieceVisionMap {
  ...
  public static final VisionMap.CameraConstants NOTE_CAM_CONSTANTS =
      new VisionMap.CameraConstants(
          "notecam", ROBOT_CENTER_TO_DETECTOR_LIMELIGHT_3D, VisionMap.CameraType.LIMELIGHT);
}
