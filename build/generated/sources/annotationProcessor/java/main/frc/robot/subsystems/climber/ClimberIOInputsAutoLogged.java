...
public class ClimberIOInputsAutoLogged extends ClimberIO.ClimberIOInputs implements LoggableInputs, Cloneable {
  ...
  public void fromLog(LogTable table) {
    ...
    climberLeftVelocityMetersPerSec = table.get("ClimberLeftVelocityMetersPerSec", climberLeftVelocityMetersPerSec);
    climberRightVelocityMetersPerSec = table.get("ClimberRightVelocityMetersPerSec", climberRightVelocityMetersPerSec);
